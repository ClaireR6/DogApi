...
RSpec.describe HomeController, type: :request do
    describe "GET #handle_random_dog_image" do
      ...
      it "renders the correct template" do
        get handle_random_dog_image_path, headers: { "ACCEPT" => "text/javascript" }
        expect(response).to render_template(:handle_random_dog_image)
      end

      it "assigns @image_url" do
        get handle_random_dog_image_path
